...
<html lang="en">
  <head>
    ...
    <title>antrian bank puntem </title>
...
<a href="landingpage.php" class="list-group-item collapsed" data-parent="#sidebar"><i class="fa fa-dashboard"></i> <span class="hidden-sm-down">Beranda</span></a>
                ...
                <div class="collapse" id="menu1">
                    <a href="tabungan.php" class="list-group-item" data-toggle="collapse" aria-expanded="false"><i class="fa fa-credit-card"></i> <span class="hidden-sm-down">bank punten plus </a>
                    
                    <a href="#" class="list-group-item" data-parent="#menu1"><i class="fa fa-credit-card"></i> <span class="hidden-sm-down">bank punten inves</a>
...
<div class="card">
  ...
  <div class="card-body">
    <h4 class="card-title">TABUNGAN bank punten plus</h4>
    <p class="card-text">Datang ke menemui CS</p>
  <ul class="list-group">
  <li class="list-group-item active">Persyaratan</li>
  <li class="list-group-item">Mengisi formulir</li>
  <li class="list-group-item">Setoran awal sebesar Rp 50.000,-</li>
